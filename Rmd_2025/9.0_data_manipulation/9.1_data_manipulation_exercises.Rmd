...
3.  **Question 6C**: Using the `%in%` operator, create a subset that includes only patients from specific years of diagnosis (2010, 2012, 2014) and specific genders ("male", "female").
