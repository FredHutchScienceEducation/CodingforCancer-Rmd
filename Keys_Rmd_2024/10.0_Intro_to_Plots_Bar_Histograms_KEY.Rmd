---
title: "Intro to Plots: Scatterplots"
author: "Sam Hart & Katherine Brower"
date: "2/1/20224"
output: html_document
---

# Intro to Plotting: Scatterplots
...
```{r}
bar_plot <- ggplot(clinical, aes(mutation.in.TP53)) 
bar_plot
...
```{r}
histogram <- ggplot(data = clinical, aes(x= height))
histogram
```
