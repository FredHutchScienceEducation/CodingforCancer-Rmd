...
In the Scatterplots and Boxplots lesson, we created a scatterplot relating smoking to the number of ERCC2 signature mutations. Use what we learned in the lesosn to create a more presentable plot.
