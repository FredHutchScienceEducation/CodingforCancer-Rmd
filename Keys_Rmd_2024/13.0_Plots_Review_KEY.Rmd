...
# missing data? this one won't throw an error but the plot looks... lacking
```{r}
...
# This code won't throw an error message, but it doesn't include the axis labels you 
# coded for, what's going on? 
```{r}
