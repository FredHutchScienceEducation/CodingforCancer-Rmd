...
### convert the column, cigarettes_per_day from days to months using pipes, as a new column called cigarettes_per_month
### Use the average number of days in a month (30)
```{r}
