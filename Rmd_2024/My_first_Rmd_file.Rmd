...
# 12a) load both tidyverse and penguins dataset from the palmerpenguins package
```{r}

```

# 12b) get the dimensions of the penguins dataset (number of rows and columns)
```{r}

```

# subsetting dataframes rows and columns
# 13a) Filter penguins to only include Adelie penguins and save as an object called filtered_rows
```{r}

```

# 13b) Subset penguins to 4 columns of your choice
```{r}
...
# creating vectors
# 14) Create a vector by setting it equal to a column in penguins (choose a column made up of numerics or integers) 
